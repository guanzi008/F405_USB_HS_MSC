...
typedef enum {
    ...
    LCD_ZH_NO_KEY = 37,
    LCD_ZH_MENU_USB_DEBUG_S = 38,
    LCD_ZH_MENU_SECURITY_KEY_S = 39,
    LCD_ZH_MENU_SPI_FLASH_S = 40,
    LCD_ZH_MENU_INPUT_DEV_S = 41,
    LCD_ZH_MENU_WIPE_KEY_S = 42,
    LCD_ZH_MENU_DELETE_KEY_S = 43,
    LCD_ZH_COUNT
} lcd_zh_id_t;
